...
import com.musicmanager.service.RemoteServiceException;
...
public class RemoteCallUtils {
    ...
    protected Object callCompatibleMethod(Object instance,
        ...
        if (method == null) {
            ...
            //System.out.printf("\nmethodCount = %d\n", methodCount);
            //System.out.print("\nconvertedParameters :\n");
            //System.out.print(convertedParameters);
            //System.out.print("\n end convertedParameters \n");
