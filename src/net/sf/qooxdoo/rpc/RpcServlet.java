...
import com.musicmanager.service.RemoteService;
import com.musicmanager.service.Service;
...
public class RpcServlet extends HttpServlet {
    ...
    public synchronized Service getServiceInstance(HttpSession session,
        ...
        if (inst == null) {
        	log("serviceClassName  "+ serviceClassName);
        	serviceClassName = "com.musicmanager.service." + serviceClassName;
    ...
    protected String handleRPC(HttpServletRequest request,
        ...
        if (serviceClassName == null && methodName.equals("refreshSession")) {
            ...
            try {
            	...
            	log("parameterCount = "+args.length());
        ...
        if (jsTransportId != null) {
            try {
                if (!checkReferrer(request)) {
                    ...
                    //log("RpcServlet, doGet, before calling handleRPC");
    ...
    public void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if (!checkReferrer(request) || contentType == null ||
                ...
                //System.out.println("Request string: " + requestString);
                log("RpcServlet, doPost, before calling handleRPC contentType :" + contentType);
